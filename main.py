...
if __name__ == '__main__':
    ...
    if opt.ssl:
        ...
        X = np.load('/data/0shared/zhangwenrui/processed_npys/ptbxl_train_all.npy')
    ...
    if opt.load:
        ...
        model = Model(seq_len, patch_len, dim, n_classes, in_dim).to(device)
    if opt.sl:
        train_X, train_y = np.load('/data/0shared/zhangwenrui/processed_npys/ptbxl_train_all.npy'), np.load('/data/0shared/zhangwenrui/npys/ptbxl_train_label.npy')
        valid_X, valid_y = np.load('/data/0shared/zhangwenrui/processed_npys/ptbxl_valid_all.npy'), np.load('/data/0shared/zhangwenrui/npys/ptbxl_valid_label.npy')
